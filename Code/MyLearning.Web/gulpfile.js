...
var pkg = require('../nodePackages/package.json');
var common = require('./build-gulp/common.js');
/*
 * Auto load all gulp plugins
 */
var gulpLoadPlugins = require("../npmPackages/node_modules/gulp-load-plugins");
...
gulp.task('bundlecss', function () {
    return gulp.src(pkg.paths.source.less)
        .pipe(plug.size({showFiles: true}))
        .pipe(plug.less({ compress: true }))
        .pipe(plug.minifyCss({keepBreaks: false}))
...
gulp.task('build-watcher', function() {
     ...
     */
    gulp.watch([pkg.paths.source.less,
        pkg.paths.source.js,
